...
public class DataProvider {
    ...
    private static List<Motor>initDataMotor(Context ctx) {
        ...
        motors.add(new Motor(ctx.getString(R.string.toyota_nama), ctx.getString(R.string.toyota_asal),
                ctx.getString(R.string.toyota_deskripsi), R.drawable.str));
        motors.add(new Motor(ctx.getString(R.string.honda_nama),  ctx.getString(R.string.Honda_asal),
                ctx.getString(R.string.honda_deskripsi), R.drawable.civic));
        motors.add(new Motor(ctx.getString(R.string.BMW_nama), ctx.getString(R.string.BMW_asal),
                ctx.getString(R.string.BMW_deskripsi), R.drawable.bwm));
        motors.add(new Motor(ctx.getString(R.string.Mustang_nama), ctx.getString(R.string.Mustang_asal),
                ctx.getString(R.string.Mustang_deskripsi), R.drawable.mustang));
        motors.add(new Motor(ctx.getString(R.string.Mercedes_benz_nama), ctx.getString(R.string.Mercedes_benz_asal),
                ctx.getString(R.string.Mercedes_benz_deskripsi), R.drawable.merce));
        motors.add(new Motor(ctx.getString(R.string.Tesla_nama), ctx.getString(R.string.Tesla_asal),
                ctx.getString(R.string.Tesla_deskripsi), R.drawable.tesla));
        return motors;
    }
